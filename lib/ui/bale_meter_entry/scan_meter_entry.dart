...
class BaleScanMeterEntry extends StatefulWidget {
  int? index;
  List<TextEditingController>? barcodeControllerList;
  BaleScanMeterEntry({Key? key, this.index, this.barcodeControllerList})
      : super(key: key);

  @override
  State<BaleScanMeterEntry> createState() => _BaleScanMeterEntryState();
}

class _BaleScanMeterEntryState extends State<BaleScanMeterEntry> {
